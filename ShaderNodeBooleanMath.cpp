class ShaderNodeBooleanMath : public Module {
public:
  ...
  override auto GenerateTokenString() : AbstractToken[] {
    ...
    if (op == "NOT") {
      return {WildcardToken("Boolean2"), TextToken(" = !"),
              WildcardToken("Boolean0"), TextToken(";")};
    }
    ...
    return {WildcardToken("Boolean2"), TextToken(" =" + prefix),
            WildcardToken("Boolean0"), TextToken(infix),
            WildcardToken("Boolean1"), TextToken(suffix)};
  }
};
