class ShaderNodeMapRangeModule : public Module {
  public:
  ...
  override auto GenerateTokenString(): AbstractToken[] {
    ...
    // STEPPED Interpolation ist ein Sonderfall, da hier der "Steps"-Input mit übergeben werden muss
    if (interp_type == "STEPPED") {
      return {
        WildcardToken(result_out), 
        TextToken(" = " + func_name + "("), 
